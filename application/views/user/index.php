                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-7">
                            <div class="welcome-text">
                                ...
                                <h2>
                                <span>SELAMAT DATANG DI</span> <span class="coloring">CLOUD HOTEL</span>
                                </h2>
                                <h1 class="cd-headline clip">
                                    <span>KEUNGGULAN</span>
                                    <span class="cd-words-wrapper coloring">
                                        <b class="is-visible"> HOTEL</b>
                                        <b>KAMAR</b>
                                        <b>FASILITAS</b>
                                    </span>
                                </h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title mb-80">
                            ...
                            <p>Aplikasi ini dirancang dengan pemograman Web Framework</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="about-chondo">
                            <div class="about-member">
                                <img src="<?=base_url()?>/assets/images/FOTO.jpg" alt="">
                                <h3>Mangaraja jose</h3>
